...
<div class="bande-stick">
    ...
    <script>
     ...
     <?php
    if ($_POST['selection_type_location'] == 'toutes') { ?>
        <table>
        <thead>
            <tr>
        ...
        <tbody>
        <?php
            $req_location = "SELECT *, ville_garage_depart.ville AS ville_depart, ville_garage_arrivee.ville AS ville_arrivee
            FROM louer
            ...
            $req_location_res = mysqli_query($connexion, $req_location);
            while ($ligne = mysqli_fetch_array($req_location_res)) {
                ?>
                <tr>
    ...
    ?>
    <?php
    if ($_POST['selection_type_location'] == 'encours') { ?>
        <table>
        <thead>
            <tr>
                <th>Id de la location</th>
        ...
        <?php
            ...
            JOIN modeles USING(id_modele)
            JOIN marque USING(id_marque)
            WHERE (CURRENT_DATE >= date_depart) AND (CURRENT_DATE <= date_arrivee) ";
            $req_location_res = mysqli_query($connexion, $req_location);
            while ($ligne = mysqli_fetch_array($req_location_res)) {
                ?>
                <tr>
    ...
    ?>
    <?php
    if ($_POST['selection_type_location'] == 'termine') { ?>
        <table>
        <thead>
            <tr>
                <th>Id de la location</th>
        ...
        <?php
            ...
            JOIN modeles USING(id_modele)
            JOIN marque USING(id_marque)
            WHERE (CURRENT_DATE > date_arrivee)";
            $req_location_res = mysqli_query($connexion, $req_location);
            while ($ligne = mysqli_fetch_array($req_location_res)) {
                ?>
                <tr>
    ...
    ?>
    <?php
    if ($_POST['selection_type_location'] == 'avenir') { ?>
        <table>
        <thead>
            <tr>
                <th>Id de la location</th>
        ...
        <?php
            ...
            JOIN modeles USING(id_modele)
            JOIN marque USING(id_marque)
            WHERE (CURRENT_DATE < date_depart)";
            $req_location_res = mysqli_query($connexion, $req_location);
            while ($ligne = mysqli_fetch_array($req_location_res)) {
                ?>
                <tr>
